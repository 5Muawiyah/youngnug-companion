(() => {
  ...
  var YN_ATS_URL_RULES = [
    {
      ...
      fingerprint: (doc) => !!doc.querySelector(
    ...
    },
    {
      ...
      fingerprint: (doc) => !!doc.querySelector(
        ".postings-btn, form[action*='lever'], [class*='lever-'], input[name='urls[LinkedIn]'], .application-question[data-qa]"
      )
    },
    {
      ...
      fingerprint: (doc) => !!doc.querySelector(
        "#field-first_name, [id^='field-'][name^='job_application'], form[action*='personio']"
      )
    },
    {
      ...
      fingerprint: (doc) => !!doc.querySelector(
        "#application_form_application_first_name, form[action*='pinpointhq'], [id^='application_form_application_']"
      )
    },
    {
      id: "ashby",
    ...
    },
    {
      ...
      fingerprint: (doc) => !!doc.querySelector("[data-automation-id], [data-automation-id] *")
    },
    {
    ...
    },
    {
      ...
      fingerprint: (doc) => !!doc.querySelector(
        'form[data-ui="application-form"], [data-ui="apply-button"], meta[name="domain"][content="workable.com"]'
      )
    },
    {
  ...
  var YN_EMPLOYER_POSTING_URL_RULES = [
    {
      id: "indeed_employer",
